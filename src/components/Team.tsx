...
import dominicImage from "@/assets/dominic.jpg";
import ioanaImage from "@/assets/ioana.jpg";
import mihaiImage from "@/assets/mihai.jpg";
import catalinImage from "@/assets/catalin.jpg";
...
const teamMembersData = [
  ...
  },
  {
    ...
    {
    name: "team.catalin.name",
    role: "team.catalin.role",
    specialization: "team.catalin.specialization",
    description: "team.catalin.description",
    icon: Stethoscope,
    image: catalinImage,
    initials: "MC",
  },
  {
    name: "team.barbu.name",
    role: "team.barbu.role",
    specialization: "team.barbu.specialization",
    description: "team.barbu.description",
    icon: Activity,
    image: dominicImage,
    initials: "DB",
  },
    {
    name: "team.ioana.name",
    role: "team.ioana.role",
    specialization: "team.ioana.specialization",
    description: "team.ioana.description",
    icon: Stethoscope,
    image: ioanaImage,
    initials: "IZ",
  },
  {
    name: "team.mihai.name",
    role: "team.mihai.role",
    specialization: "team.mihai.specialization",
    description: "team.mihai.description",
    icon: Activity,
    image: mihaiImage,
    initials: "MC",
  },
