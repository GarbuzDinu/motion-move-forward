...
const servicesData = [
  { service: "prices.services.evaluation", duration: "20-50 min", price: "200 lei" },
  { service: "prices.services.medicalConsult", duration: "20-50 min", price: "300 lei" },
  { service: "prices.services.physiotherapy", duration: "50 MINUTE", price: "300 LEI" },
  { service: "prices.services.kinesiotherapy", duration: "50 MINUTE", price: "300 LEI" },
  { service: "prices.services.sportMassage", duration: "50 MINUTE", price: "350 LEI" },
  { service: "prices.services.cryosauna", duration: "-", price: "300 LEI" },
  { service: "prices.services.boots", duration: "30 MINUTE", price: "150 LEI" },
  { service: "prices.services.hyperbaricChamber", duration: "30-60 min", price: "250 lei" },
];
...
const orthoServicesData = [
  ...
  { service: "prices.ortho.vascoInfiltration", duration: "-", price: "1700 lei" },
  { service: "prices.ortho.prpInfiltration", duration: "-", price: "1700" },
];

const subscriptionsData = [
  { title: "prices.subscriptions.sportMassage10", price: "2.975 LEI", note: "prices.subscriptions.discount15" },
  { title: "prices.subscriptions.kinesiotherapy10", price: "5100 LEI", note: "prices.subscriptions.discount15" },
  { title: "prices.subscriptions.cryosauna10", price: "2.850 LEI", note: "prices.subscriptions.discount5" },
  { title: "prices.subscriptions.fullCombo10", price: "6.975 LEI", note: "prices.subscriptions.discount22_5" },
  { title: "prices.subscriptions.hyperbaric10", price: "2.000 lei", note: "prices.subscriptions.discount20" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <Card className="group hover:shadow-card-hover transition-all duration-300 animate-fade-in border-border/50 bg-card">
            <CardHeader className="text-center pb-6">
              <h3 className="text-2xl font-bold text-foreground">{t("prices.services.title")}</h3>
            </CardHeader>
          ...
          <Card className="group hover:shadow-card-hover transition-all duration-300 animate-fade-in border-border/50 bg-card">
            <CardHeader className="text-center pb-6">
              <h3 className="text-2xl font-bold text-foreground">{t("prices.ortho.title")}</h3>
            </CardHeader>
            <CardContent className="space-y-3">
          ...
          {subscriptionsData.map((sub, i) => (
            ...
            >
              <CardHeader className="text-center pb-4">
                <h3 className="text-xl font-bold text-foreground">{t(sub.title)}</h3>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-2xl font-semibold text-primary">{sub.price}</p>
                <p className="text-muted-foreground italic mt-2">{t(sub.note)}</p>
              </CardContent>
            </Card>
          ))}
        </div>
